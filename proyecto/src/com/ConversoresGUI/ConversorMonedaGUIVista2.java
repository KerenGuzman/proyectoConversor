...
/**
 * La clase COnversorMonedaGUIVista2 es la segunda interfaz a mostrar en el programa, en ella se ejecutaran las opciones de moneda a convertir, para
 * posteriormente redirigirnos a la vista con el resultado
 * @author KEREN
 */
public class ConversorMonedaGUIVista2 extends ConversorAluraBase{
    ...
    /**
     * Este Override recibe las acciones en cada boton y asi mismo nos redirige a las otras vistas del programa
